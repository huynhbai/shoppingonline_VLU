...
// Truy cập qua: http://your-domain.com/admin
...
// Truy cập qua: http://your-domain.com/
// Sử dụng path.join với '..' để lùi ra khỏi thư mục server tìm folder build
app.use(express.static(path.join(__dirname, '..', 'client-customer', 'build')));

// Route cuối cùng để handle React Router (Single Page Application)
app.get('*', (req, res) => {
