        ...
        <div style={{ maxWidth: '1200px', margin: '40px auto', padding: '0 20px', fontFamily: 'Arial, sans-serif' }}>
          ...
          <div style={{ display: 'flex', gap: '50px', alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: '1.2', textAlign: 'left' }}>
              ...
              {/* --- CHỌN SỐ LƯỢNG, NÚT QUAY LẠI & NÚT MUA (NẰM CÙNG HÀNG) --- */}
              <div style={{ display: 'flex', alignItems: 'center', gap: '20px', marginTop: '40px' }}>
                
                {/* NÚT QUAY LẠI (Nằm bên trái) */}
                <button 
                ...
                >
                  ...
                  {/* Ô CHỌN SỐ LƯỢNG MỚI (NÚT BẤM TO) */}
                  <div style={{ display: 'flex', alignItems: 'center', border: '1px solid #ccc', height: '48px', borderRadius: '4px', overflow: 'hidden' }}>
                    <span style={{ padding: '0 15px', color: '#888', borderRight: '1px solid #eee' }}>Qty:</span>
                    
                    {/* Nút Giảm */}
                    <button 
                      type="button"
                      onClick={() => this.setState({ txtQuantity: Math.max(1, parseInt(this.state.txtQuantity) - 1) })}
                      style={{ width: '40px', height: '100%', border: 'none', background: '#f4f4f4', cursor: 'pointer', fontSize: '20px', fontWeight: 'bold' }}
                    >
                      −
                    </button>
                    ...
                    <button 
                      type="button"
                      onClick={() => this.setState({ txtQuantity: parseInt(this.state.txtQuantity) + 1 })}
                      style={{ width: '40px', height: '100%', border: 'none', background: '#f4f4f4', cursor: 'pointer', fontSize: '20px', fontWeight: 'bold' }}
                    >
                      +
                    </button>
                ...
                <button 
                  ...
                  style={{ 
                    ...
                    fontSize: '16px',
                    letterSpacing: '1px',
                    flex: '1' // Nút này sẽ co giãn để chiếm phần không gian còn lại
                  }}
                >
                  ADD TO CART
                </button>
