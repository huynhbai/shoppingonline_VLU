...
class Signup extends Component {
  ...
  render() {
  return (
    <div className="auth-container"> {/* Dùng class chung để căn giữa */}
      ...
      <form>
        ...
        {/* Nút bấm đã được căn giữa bằng class btn-submit-center */}
        <input type="submit" value="SIGN-UP" className="btn-submit-center" onClick={(e) => this.btnSignupClick(e)} />
      </form>
    </div>
  );
}
